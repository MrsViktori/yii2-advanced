...
class VerifyEmailCest
{
    ...
    {
        $I->amOnRoute('api/verify-email', ['token' => '']);
    ...
    {
        $I->amOnRoute('api/verify-email', ['token' => 'wrong_token']);
        $I->canSee('Bad Request', 'h1');
    ...
    {
        $I->amOnRoute('api/verify-email', ['token' => 'already_used_token_1548675330']);
        $I->canSee('Bad Request', 'h1');
        $I->canSee('Wrong verify email token.');
    }
    ...
    {
        $I->amOnRoute('api/verify-email', ['token' => '4ch0qbfhvWwkcuWqjN8SWRq72SOw1KYT_1548675330']);
